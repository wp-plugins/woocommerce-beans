   ...
   public function confirm_beans_transaction($order_id, $order_status, $new_status){
                        ...
                        <td>
                            <div style="text-align: right">
                                <form id="beans_redeem_form" action="" method="post">
                                    ...
                                    <button class='button' type="submit">Redeem my beans</button> 
                                </form>
                            </div>
                        </td>
                    </tr>
    ...
    public function render_account_page($page){
        ...
        <div  class="beans-div-account-page">
            <a href="//<?php echo Beans::$domain."/$".$this->opt['card_name'] ?>" class="button" target="_blank">Beans account </a> 
        </div>
        <?php
    }
