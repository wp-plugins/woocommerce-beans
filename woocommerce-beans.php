...
class WC_Beans{
    ...
    function __construct(){
        ...
        add_filter('woocommerce_get_shop_coupon_data',                        array( $this, 'get_beans_coupon'), 5, 2);
    ...
    public function get_beans_coupon($coupon, $coupon_code){
        ...
        self::log_info("Coupon: /$coupon_code/");
                    ...
                    <td>
                        <div style="padding: 10px; text-align: left;" >
                            <?php
                                 ...
                                 echo "<br/>";
                                 printf(
                                     __('Earn %1$s with this purchase.', 'woocommerce-beans'),
                            ...
                            <a class="beans-info" href="//www.beans.cards/$<?php echo $this->opt['card_name']; ?>/"  target="_blank"  onclick="Beans.show(); return false;">
                                <?php
                                    printf(
                                        ...
                                        print_beans($_SESSION['beans_rate']),
                                        wc_price(1)
                                    );
                                ?>
    ...
    public function render_account_page($page){
        ...
        <div class="beans-div-account-page">
            <div>
                <?php  
                    printf(__('You have %1$s', 'woocommerce-beans'), print_beans($account['beans']));
                ?>
    ...
    public function render_product_page($page){
        ...
        if (!empty($min_price) && !empty($max_price)){
            ...
            $get_product_msg = sprintf(__('Get this product for  %1$s - %2$s.', 'woocommerce-beans'), print_beans($beans_to_buy_min), print_beans($beans_to_buy_max));
            $buy_product_msg = sprintf(__('Buy this product and earn %1$s - %2$s.', 'woocommerce-beans'), print_beans($beans_to_earn_min), print_beans($beans_to_earn_max));
        ...
        <div class="beans-block-product-page" >
            ...
            <?php if ($this->opt['beans_on_product_page']) echo $get_product_msg;?>

            <br/>

            <?php echo $buy_product_msg; ?>
