...
class WC_Beans{
    ...
    public function cancel_redeem_beans(){
        // TODO: Track when user choose to remove coupon using wc (when user click on remove coupon link )
        global $woocommerce;
    ...
    public function render_cart_page($page){
        ...
        if ($this->beans_account__id && $_SESSION['beans_coupon_data']) {
            ...
            $info_html = __('Connect with Beans to get rewarded when you make a purchase, 
                             like our Facebook page and more...', 'woocommerce-beans');
                    ...
                    <td>
                        <div style="padding: 10px; text-align: left">
                            <?php
                                 ...
                                 printf(
                                 __('%s beans </span> // %s', 'woocommerce-beans'),
