...
class WC_Beans{
    ...
    public function render_cart_checkout_page($page){
        ...
        if ($this->beans_account__id && $_SESSION['beans_coupon_data'] && $_SESSION['beans_to_redeem'] > 0) {
            ...
            $form_html = "<button class='beans-button beans-connect' href='//www.beans.cards/$".$this->opt['card_name']." target='_blank'  onclick='Beans.show(); return false;'
        ...
        <div class="beans-div-account-page">
            <div style="cursor: pointer" onclick="Beans.show();">
                ...
                <a class="beans-info" href="//www.beans.cards/$<?php echo $this->opt['card_name']; ?>/"  target="_blank"  onclick="Beans.show(); return false;">
                    ...
                    ?>
                <span class="beans-info-tag"> i</span></a>
