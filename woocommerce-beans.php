   ...
   public function confirm_beans_transaction($order_id, $order_status, $new_status){
                    ...
                    <td>
                        <div style="padding: 10px; text-align: left">
                            <?php
                                 ...
                                 echo '<span class="beans-unit">';
                                 printf(
                                 __('%1$s beans </span> // %2$s', 'woocommerce-beans'),
    ...
    public function render_product_page($page){
        ...
        <div  class="beans-div-product-page">
            <?php  
                 printf(
                 __('Get this product for  %s beans', 'woocommerce-beans'),
            ...
            <?php  
                 printf(
                 __('Buy this product and earn %s beans', 'woocommerce-beans'),
