...
if ( ! class_exists( 'WC_Beans' ) ) :
        ...
        public function redeem_beans(){
            ...
            if ($account['beans'] < $min_coupon ){
                wc_add_notice(
                    ...
                    sprintf(__( 'Minimal redeem is %1$s.', 'woocommerce-beans' ), print_beans($min_coupon)),
                    'error' );
                return;
            }
    ...
    public function render_order_page($wc_order){        if(!$wc_order) return;
