 ...
 * Text Domain: woocommerce-beans,woocommerce-beans-admin
...
if ( ! class_exists( 'WC_Beans' ) ) :
    ...
    class WC_Beans{
        ...
        function __construct(){
            ...
            $this->filters = array(
                ...
                array('woocommerce_after_shop_loop_item_title',         'render_shop_page',             15, 1),
            );
        ...
        public function initialize(){
            ...
            $this->debug = isset($_GET['beans-debug']);
            ...
            if((empty($_SESSION['beans_name']) || empty($_SESSION['beans_rate']))
                    && $this->opt['card_id']) {
    ...
    public function run_debug(){
        ...
        $locale_path = WP_LANG_DIR . "woocommerce-beans/woocommerce-beans-admin-$locale.mo";
        beans_log_info("Localization path admin 1: '$locale_path' exists=".file_exists($locale_path));

        $locale_path = plugin_dir_path(__FILE__) . "languages/woocommerce-beans-admin-$locale.mo";
        beans_log_info("Localization path admin 2: '$locale_path' exists=".file_exists($locale_path));
