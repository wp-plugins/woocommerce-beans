...
class WC_Beans_Settings
{
    ...
    public function install()
    {
        ...
        if(empty($opt)){
            ...
            $default_option = array(
                ...
                'private_key' => '',
                'beans_popup' => true,
                'beans_invite_after_purchase' => false,
                'beans_on_shop_page' => false,
                'beans_on_product_page' => true,
    ...
    public static function check_opt(){
        ...
        if(!isset($opt['beans_on_product_page']))
            $opt['beans_on_product_page'] = true;
        
        if(!isset($opt['beans_on_shop_page']))
            ...
            <?php else : ?>
                 <div style="margin-top: 40px">
                    ...
                    <form method="post" action="">
                        <input type="hidden" name="action" value="beans_invite_after_purchase">
                        <input type="submit" id="beans_invite_after_purchase" class="button" value="<?php _e('Send invitations', 'woocommerce-beans' ); ?>"/>
                    </form>
                 </div>
            <?php endif; ?> 
             ...
             <div style="margin-top: 40px">
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('Invite your customers to join your reward program when they make a purchase', 'woocommerce-beans' ); ?></th>
                            <td>
                                <input type='checkbox' <?php if ($opt['beans_invite_after_purchase']) { echo 'checked="checked"'; }; ?> name="beans_invite_after_purchase"> </input>
                                <p class="description"><?php _e('Invite your customers to join your reward program. This invitation is only sent once.', 'woocommerce-beans' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
    ...
    public function update_settings()
    {
        ...
        if (empty($this->errors))
        {
         ...
         if(isset($_POST['beans_invite_after_purchase']))
         {
            $opt['beans_invite_after_purchase'] = true;
         }
         else {
             $opt['beans_invite_after_purchase'] = false;
         }
