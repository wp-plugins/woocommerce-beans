...
//         $color = "<span style='color: #00aa00'>&#9632;</span>";
    ...
    public function install()
    {
        ...
        if(empty($this->opt)){
            ...
            add_option(self::OPT_NAME, $this->opt);
        }
    ...
    public static function check_opt(){
        ...
        if(empty($opt['card_name']) || empty($opt['card_id'])){
        ...
        if(!isset($opt['invitation_sent']))
            $opt['invitation_sent'] = true;
            ...
            <?php endif; ?>
             ...
             <div style="margin-top: 40px">
                ...
                <form method="post" action="">
                    ...
                    <?php if (!$this->opt['secret_key']) : ?>
                        <tr valign="top">
                            <th scope="row"><?php _e('Public Key', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('Secret Key', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                    ...
                    <?php endif; ?>
                        <tr valign="top">
                            <th scope="row"><?php _e('Beans price on shop', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                                <input type='checkbox' <?php if ($this->opt['beans_on_shop_page']) { echo 'checked="checked"'; }; ?> name="beans_on_shop_page"/>
                                <p class="description"><?php _e('Show beans price for each product on shop page', 'woocommerce-beans-admin' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row"><?php _e('Beans price for products', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                                <input type='checkbox' <?php if ($this->opt['beans_on_product_page']) { echo 'checked="checked"'; }; ?> name="beans_on_product_page"/>
                                <p class="description"><?php _e('Show beans price on product page', 'woocommerce-beans-admin' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row"><?php _e('Convert visitors', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                                <input type='checkbox' <?php if ($this->opt['beans_popup']) { echo 'checked="checked"'; }; ?> name="beans_popup"/>
                                <p class="description"><?php _e('Automatically show Beans to first time visitors. This will only appear once.', 'woocommerce-beans-admin' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row"><?php _e('Email notification', 'woocommerce-beans-admin' ); ?></th>
                            <td>
                                <input type='checkbox' <?php if ($this->opt['beans_invite_after_purchase']) { echo 'checked="checked"'; }; ?> name="beans_invite_after_purchase"/>
                                <p class="description"><?php _e('Send a notification to customers that forget to join your reward program before completing their order. (Recommended)', 'woocommerce-beans-admin' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
