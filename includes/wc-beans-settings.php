...
//         $color = "<span style='color: #00aa00'>&#9632;</span>";
    ...
    public function admin_notice() {
        ...
        elseif(!$this->opt['translation_done'])
        {
            echo '<div class="error"><p>'.
                __( 'Beans: Plugin language don\'t fit your\'s', 'woocommerce-beans-admin' ) .
                '<br><a href="https://wordpress.org/plugins/woocommerce-beans/faq/" target="_blank" >See how to fix this<a/>'.
                ...
                __( 'Ignore', 'woocommerce-beans-admin' ) .
                '</a>'.
                '</form>'.
                '</p></div>';
        }
