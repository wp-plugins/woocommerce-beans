...
//         $color = "<span style='color: #00aa00'>&#9632;</span>";
    ...
    public static function check_opt(){
        ...
        if(!isset($opt['beans_rate_msg']))
            $opt['beans_rate_msg'] = false;
                    ...
                    <?php endif; ?>
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                ...
                                <label for="beans_rate_msg_id" class="description"><?php _e('Show long beans rate message' , 'woocommerce-beans-admin' ); ?></label>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td colspan="2">
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                ...
                                <label for="beans_invite_after_purchase_id" class="description"><?php _e('Send a notification to customers that forget to join your reward program before completing their order. (Recommended)', 'woocommerce-beans-admin' ); ?></label>
                            </td>
                        </tr>
                        <tr valign="top">
