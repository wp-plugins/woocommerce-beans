...
class WC_Beans_Settings
{
    ...
    {
        // Install database
        if(get_option(self::OPT_DB_VERSION)!=$beans_db_version){
            $this->db_install();
        }
    ...
    public function db_install()
    {
        ...
        if(get_option(self::OPT_DB_VERSION)){
            update_option( self::OPT_DB_VERSION,$beans_db_version);
        }else{
            add_option( self::OPT_DB_VERSION,$beans_db_version);  
        }
