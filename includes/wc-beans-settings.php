                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                {
                                    var maxreed = parseInt(newValue);
                                    var minreed = parseInt(document.getElementById("range_min_redeem").innerHTML);
                                    if(maxreed<minreed){ 
                                        document.getElementById("range_min_redeem").innerHTML = newValue;
                                        document.getElementById("r_min_reed").value = maxreed;
                                    }
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input id="r_min_reed" name="range_min_redeem" type="range" min="0" max="100" setp="5" value="<?php if (isset($opt['range_min_redeem'])) { echo $opt['range_min_redeem']; }else{ echo 0; }; ?>" onchange="showValue2(this.value)" />
