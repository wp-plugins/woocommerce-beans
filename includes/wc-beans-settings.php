...
class WC_Beans_Settings
{
    ...
    public function admin_notice() {
        ...
        if(!$opt['secret_key'] || !$opt['public_key'])
        {
        ...
        elseif(!$opt['invitation_sent'])
        {
            echo '<div class="error"><p>'.
                     __( 'Beans: You have not invited your customers to join your reward program. ', 'woocommerce-beans' ) .
    ...
    public function send_invitations(){
        ...
        $opt['invitation_sent'] = Beans::post('notification/bulk_create', $data);
