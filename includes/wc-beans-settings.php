...
class WC_Beans_Settings
{
    ...
    public function install()
    {
        ...
        if(empty($opt)){
            ...
            $default_option = array(
                ...
                'public_key' => '',
                'private_key' => '',
                'modal_msg' => 'Would you like to join our Beans reward program for free?',
                'beans_on_shop_page' => true,
    ...
    public static function check_opt(){
        ...
        if(empty($opt['rule_currency_spent'])){
            
            $rules = Beans::get('rule', array('uid'=> 'beans:currency_spent'));
            
            if (isset($rules[0])){
                
                $opt['rule_currency_spent'] = $rules[0];
             ...
             <div style="margin-top: 40px">
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('Modal Message', 'woocommerce-beans' ); ?></th>
                            <td>
                                <textarea class="regular-text code" name="beans_modal_msg"> <?php echo $opt['modal_msg']; ?> </textarea>
                                <p class="description"><?php _e('Enter a message to be displayed to first time visitors. Leave it empty to disable.', 'woocommerce-beans' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
