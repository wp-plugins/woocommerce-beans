...
//         $color = "<span style='color: #00aa00'>&#9632;</span>";
    ...
    public function install()
    {
        ...
        if(empty($this->opt)){
            ...
            $this->opt = array(
                ...
                'beans_rate_msg1' => 'Exchange [Beans] for [CURRENCY] in our shop',
                'invitation_sent' => false,
                'beans_on_shop_page' => false,
                'default_button_style' => false,
    ...
    public function admin_notice() {
        ...
        elseif(empty($this->opt['translation_done']) && strpos(get_locale(),'en_') === false )
        {
            echo '<div class="error"><p>
                <br>
                <a href="https://wordpress.org/plugins/woocommerce-beans/faq/" target="_blank" >
                '.
                __( 'Beans: Use Beans in '.get_bloginfo( 'language' ).'.', 'woocommerce-beans-admin' ) .
                '
                <a/></p>'.
                '<form method="post" id="beans_translation_done" action="" >'.
                '<input type="hidden" name="translation_done" value="1"/>'.
                '<p><a href="#" onclick="document.getElementById(\'beans_translation_done\').submit(); return false;">' .
        ...
        {
            echo '<div class="error"><div style="margin: 10px auto;">'.
             ...
             <div style="margin-top: 40px">
                ...
                <form method="post" action="">
                    ...
                    <?php endif; ?>
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <input type='checkbox' <?php if ($this->opt['beans_rate_msg']) { echo 'checked="checked"'; }; ?> name="beans_rate_msg"/>
                                <label class="description"><?php _e('Replace the info tag "'.floor($_SESSION['beans_rate']).' Beans // '.wc_price(1).'" by ' , 'woocommerce-beans-admin' ); ?><input type="text" size="60" name="beans_rate_msg1" value="<?php echo $this->opt['beans_rate_msg1']; ?>" />
                            </td>
                        </tr>
                        <tr valign="top">
                            <td colspan="2">
...
<!--            no beans account-->
    ...
    public function update_settings()
    {
         ...
         $this->opt['beans_rate_msg1'] = $_POST['beans_rate_msg1'];
