...
//                'beans_rate_msg_text' => __('%1$s // %2$s', 'woocommerce-beans'),
    ...
    public function admin_menu()
    {
        if (current_user_can('manage_woocommerce'))
            add_submenu_page('woocommerce', __( 'Beans Settings', 'woocommerce-beans' ),
        ...
        if(empty($this->opt['translation_done']))
        {
            ...
            echo '<div class="error" style="margin-left: auto"><div style="margin: 10px auto;"> Beans: '.
                ...
                '<form method="post" id="beans_translation_done" action="" >'.
                    ...
                    __( 'No thanks, I prefer English.', 'woocommerce-beans' ) .
                    '</a>'.
                '</form>'.
                '</div></div>';
        }
                    ...
                    <div style="background-color: #FCEFA1; padding: 10px; border: 1px solid #DDDDDD; margin: 20px auto">
                        <?php
                            _e('Beans is currently in Test Mode. Only the shop manager is able to see and use Beans. '.
                                'The plugin is disabled for your customers and visitors. ', 'woocommerce-beans');
                            ...
                            _e('When you are ready, just deactivate the test mode to allow your customers '.
                                'to see and join your reward program.', 'woocommerce-beans' );
                        ?>
                    </div>
...
<!--                        </tr>-->
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                ...
                                <label for="disable_product_page_id" class="description"><?php _e('Disable Beans on product page', 'woocommerce-beans' ); ?></label>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td colspan="2">
                                ...
                                <label for="beans_on_shop_page_id" class="description"><?php _e('Show beans price for each product on shop page', 'woocommerce-beans' ); ?></label>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td colspan="2">
